...
public class RateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void writeDetailsToDB() {
        ...
        shifts.add(new Shift(String.valueOf(user.getHourlyWage()), "1", "5", "7", "15", "0", "0"));
        shifts.add(new Shift(String.valueOf(user.getHourlyWage()), "2", "5", "15", "23", "15", "0"));
        user.setShifts(shifts);
        paychecks.put("5#2019", new Paycheck("5#2019", user));
        user.setPaychecks(paychecks);

        shifts = new ArrayList<>();
        shifts.add(new Shift(String.valueOf(user.getHourlyWage()), "1", "7", "7", "15", "10", "10"));
        shifts.add(new Shift(String.valueOf(user.getHourlyWage()), "2", "7", "15", "23", "0", "0"));
        shifts.add(new Shift(String.valueOf(user.getHourlyWage()), "3", "7", "7", "15", "10", "10"));
        user.setShifts(shifts);
